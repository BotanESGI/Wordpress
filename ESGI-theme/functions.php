...
// Add Contact Section
    $wp_customize->add_section('contacts_section', array(
        'title' => __('Contacts', 'theme_textdomain'),
        'priority' => 50,
    ));

    // Define contact fields and their default labels
    $contact_fields = [
        'contact_name1' => 'Location',
        'contact_address1' => '242 Rue du Faubourg Saint-Antoine<br>75020 Paris FRANCE',
        'contact_name2' => 'Manager',
        'contact_contact2' => '+33 1 53 31 25 23<br>info@company.com',
        'contact_name3' => 'CEO',
        'contact_contact3' => '+33 1 53 31 25 25<br>ceo@company.com',
    ];

    // Loop through contact fields to add settings and controls
    ...
    // Add setting and control for Contact Us image
    $wp_customize->add_setting('contact_us_image', array(
        'default' => get_template_directory_uri() . '/assets/img/Concert1.png',
        'sanitize_callback' => 'esc_url_raw',
    ));

    $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'contact_us_image', array(
        'label' => __('Contact Us Image', 'theme_textdomain'),
        'section' => 'contacts_section',
        'settings' => 'contact_us_image',
    )));
    ...
    $wp_customize->add_section('esgi_section', [
        ...
        $wp_customize->add_setting('top_image', [
            'type' => 'theme_mod',
            'capability' => 'edit_theme_options',
            'default' => get_template_directory_uri() . '/assets/img/top-image.jpg',
            'sanitize_callback' => 'esc_url_raw',
        ]);
    ...
    for ($i = 1; $i <= 4; $i++) {
        ...
        $wp_customize->add_setting("team_image_$i", array(
            'default' => get_template_directory_uri() . "/assets/img/team$i.jpg",
            'sanitize_callback' => 'esc_url_raw',
        ));
    ...
    for ($i = 1; $i <= 4; $i++) {
        ...
        $wp_customize->add_setting("service_image_$i", array(
            'default' => get_template_directory_uri() . "/assets/img/service$i.jpg",
            'sanitize_callback' => 'esc_url_raw',
        ));
    ...
    $wp_customize->add_setting('service_corp_image', [
        'type' => 'theme_mod',
        'capability' => 'edit_theme_options',
        'default' => get_template_directory_uri() . '/assets/img/corp.jpg',
        'sanitize_callback' => 'esc_url_raw',
    ]);
    ...
    // Ajout des paramètres pour la page Contacts dans le customizer
    $wp_customize->add_section('contacts_section', array(
        'title' => __('Contacts', 'theme_textdomain'),
        'priority' => 50,
    ));
    ...
    for ($i = 1; $i <= 6; $i++) {
        $wp_customize->add_setting("partner_logo_$i", array(
            'default' => get_template_directory_uri() . "/assets/img/partner$i.jpg",
            'sanitize_callback' => 'esc_url_raw',
        ));
...
function esgi_create_initial_pages() {
    $pages = [
        ...
        'contacts' => ['title' => 'Contacts', 'page' => 'page-contacts.php'], // Nouvelle page Contacts
    ];
